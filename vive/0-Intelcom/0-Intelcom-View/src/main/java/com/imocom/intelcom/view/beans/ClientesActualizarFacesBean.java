...
public class ClientesActualizarFacesBean extends AbstractFacesBean implements Serializable {
    ...
    public String redirectInsertartContacto() {
        ...
        try {
            ...
            //Se debe crear el contactoCliente nuevo, el constructor saca nullpointer porque ContactoVO tiene null en el nombre
            // y el setNombre de ContactoCliente, usa una funcion de translate
            //ContactoCliente clienteNuevo = new ContactoCliente( new ContactoVO() );
            ContactoCliente clienteNuevo = new ContactoCliente();
            ...
            String mensaje = ("Ha ocurrido un error: " + ex.getMessage());
