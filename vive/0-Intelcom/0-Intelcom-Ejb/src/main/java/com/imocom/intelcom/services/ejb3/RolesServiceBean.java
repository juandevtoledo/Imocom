...
public class RolesServiceBean extends AbstractService<Long, Rol> implements IRolesServiceLocal {
    ...
    public List listaDeUsuariosRolUno() throws ServiceException {
        ...
        try {
            ...
            return em.createNativeQuery("select distinct u.usuario, u.NOMBRE from usuario u inner join rol_usuario rus on u.ID_USUARIO = rus.ID_USUARIO where rus.ID_ROL = 1 and u.ESTADO='ACTIVO' order by u.usuario").getResultList();
