...
public class ContextListener implements ServletContextListener {
    ...
    public void contextInitialized(ServletContextEvent event) {
        ...
        System.out.println("ContextListener->IntelcomMiddleware->contextInitialized->INIT");
        ...
        System.out.println("ContextListener->IntelcomMiddleware->contextInitialized-FIN");
