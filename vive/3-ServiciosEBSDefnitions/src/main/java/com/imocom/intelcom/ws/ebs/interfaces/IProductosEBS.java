...
public interface IProductosEBS {
     ...
     * @param cotizable define si un elemento se puede cotizar de forma
     * automatica (1=si es cotizable, vacio si no)
    ...
    @WebMethod(operationName = "consultaInventarioAutomatica")
    public ProductosResponseVO consultaInventarioAutomatica(@WebParam(name = "tipoProducto") String tipoProducto,
            @WebParam(name = "marca") String marca,
            @WebParam(name = "modelo") String modelo,
            @WebParam(name = "descripcion") String descripcion,
            @WebParam(name = "cotizable") String cotizable,
    ...
    @WebMethod(operationName = "productoCotizableAutomaticamente")
    public ProductosResponseVO productoCotizableAutomaticamente(@WebParam(name = "inventory_item_id") String inventory_item_id
    ) throws ImocomWebserviceException;
    ...
    /**
     * Método que retorna el detalle de los productos que no se la han facturado
     * a un cliente
     *
     * @param nitClientes
     * @return
    ...
    /**
     * Servicio que retorna los modelos asociados a una marca de la vista
     * materializada de inventario
     *
     * @param idMarca
     * @param linea
     * @param tipoProducto
