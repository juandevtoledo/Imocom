...
import com.imocom.intelcom.ws.ebs.vo.response.ActualizarAsesorClienteResponseVO;
...
public interface IClientesEBS {
    ...
    /**
     * Consulta los clientes de la EBS por filtros NitCliente, NombreCliente,
     * Asesor, Tipo Cliente , diasSinVista
     *
     * @param nitCliente
     * @param nombreCliente
     * @param idAsesor
     * @param tipoCliente
     * @param diasSinVisita : Los dias no se ha registrado visitas para un
     * cliente
     * @param clienesPropios: Booleando que identifica si el los clientes a
     * buscar son propios
     * @return
    ...
    /**
     * Servicio Web que retorna los posicion geografica (Latitud , Longitud) de
    ...
    /**
     * Servicio web que verifica la existencia de un cliente en la EBS, buscando
     * por el NIT del cliente Si encuentra coincidencias con el NIT, de forma
     * exacta, retorna la lista de clientes
     *
     * @param nitCliente
     * @return
     * @throws ImocomWebserviceException
    ...
    @WebMethod(operationName = "actualizarAsesorCliente")
    public ActualizarAsesorClienteResponseVO actualizarAsesorCliente(
            @WebParam(name = "idAsesorOriginal") String idAsesorOriginal,
            @WebParam(name = "idAsesor") String idAsesor,
