...
<?oracle-xsl-mapper
  ...
  <!-- GENERATED BY ORACLE XSL MAPPER 11.1.1.7.0(build 140919.1004.0161) AT [WED FEB 25 16:00:13 COT 2015]. -->
?>
<xsl:stylesheet version="1.0"
  ...
  <xsl:template match="/">
    <db:InputParameters>
      ...
      <db:L_DECISION_DATE>
        <xsl:value-of select='xp20:format-dateTime(/tns:procesoActualizacionOportunidades/request/fechaEstimadaCierre,"[Y0001]-[M01]-[D01]T[H01]:[m01]:[s01]")'/>
      </db:L_DECISION_DATE>
      <db:L_CLOSE_REASON>
