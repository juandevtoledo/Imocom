...
AND AS_LEADS_ALL.WIN_PROBABILITY  > #probabilidad_inferior
AND AS_LEADS_ALL.WIN_PROBABILITY <= #probabilidad_superior
AND JGZZ_FISCAL_CODE LIKE #v_nit
AND AS_SALES_LEADS.ASSIGN_SALES_GROUP_ID like v_id_asesor